...
describe('TermUtil', () => {
  ...
  describe('#getTermsOfType', () => {
    it('should apply to the empty array', async() => {
      expect(TermUtil.getTermsOfType(empty, 'NamedNode')).toEqual([]);
    });
  ...
  describe('#getNamedNodes', () => {
    it('should apply to the empty array', async() => {
      expect(TermUtil.getNamedNodes(empty)).toEqual([]);
    });
  ...
  describe('#getLiterals', () => {
    it('should apply to the empty array', async() => {
      expect(TermUtil.getLiterals(empty)).toEqual([]);
    });
  ...
  describe('#getVariables', () => {
    it('should apply to the empty array', async() => {
      expect(TermUtil.getVariables(empty)).toEqual([]);
    });
  ...
  describe('#getDefaultGraphs', () => {
    it('should apply to the empty array', async() => {
      expect(TermUtil.getDefaultGraphs(empty)).toEqual([]);
    });
  ...
  describe('#getQuads', () => {
    it('should apply to the empty array', async() => {
      expect(TermUtil.getQuads(empty)).toEqual([]);
    });
